...
* add more units tests ([#5](https://github.com/iExec-Nox/nox-confidential-contracts/issues/5)) ([7efd613](https://github.com/iExec-Nox/nox-confidential-contracts/commit/7efd6131e070d0ae655bda3af1ff5dd469a75781))
* add release-please configuration for automated changelog generation ([e0225da](https://github.com/iExec-Nox/nox-confidential-contracts/commit/e0225da20341dc8ef1f1865cdf2e021de66eda8b))
* bump to beta 3 ([#19](https://github.com/iExec-Nox/nox-confidential-contracts/issues/19)) ([72b6b76](https://github.com/iExec-Nox/nox-confidential-contracts/commit/72b6b76b44a0f68c5474da49e9a46eb5d33190ad))
...
* implement script to send transactions on the OP chain ([e0225da](https://github.com/iExec-Nox/nox-confidential-contracts/commit/e0225da20341dc8ef1f1865cdf2e021de66eda8b))
...
* update package name in publish workflow comment ([45dc385](https://github.com/iExec-Nox/nox-confidential-contracts/commit/45dc3853d6958d3655b35a984fdc04f03a642121))
...
* add Counter contract tests for increment events and value verification ([e0225da](https://github.com/iExec-Nox/nox-confidential-contracts/commit/e0225da20341dc8ef1f1865cdf2e021de66eda8b))
* add TODO section to README for future enhancements ([62fdba9](https://github.com/iExec-Nox/nox-confidential-contracts/commit/62fdba987d60e6cb7909206feb6d45bef4977f56))
* add TypeScript configuration for project ([e0225da](https://github.com/iExec-Nox/nox-confidential-contracts/commit/e0225da20341dc8ef1f1865cdf2e021de66eda8b))
...
* remove deployment dry-run step from CI workflow ([636a6a9](https://github.com/iExec-Nox/nox-confidential-contracts/commit/636a6a9a704f7289605a202251686e29ea5a819d))
* remove unnecessary whitespace in main.yml ([0698015](https://github.com/iExec-Nox/nox-confidential-contracts/commit/0698015976e53ab78d9aa971c925a1e2995c06cd))
* update readme & dep ([#21](https://github.com/iExec-Nox/nox-confidential-contracts/issues/21)) ([29aa1a8](https://github.com/iExec-Nox/nox-confidential-contracts/commit/29aa1a81f0eb99ec073f53676fe298855963b7d0))
