 ...
 */
abstract contract ERC20ToERC7984WrapperBase is
    ...
    ERC7984Base
{
    ...
    struct ERC20ToERC7984WrapperStorage {
        mapping(euint256 unwrapAmount => address recipient) _unwrapRequests;
    }
    ...
    function _getERC20ToERC7984WrapperStorage()
        internal
        pure
        returns (ERC20ToERC7984WrapperStorage storage $)
    {
        assembly {
            // keccak256(abi.encode(uint256(keccak256("nox.storage.ERC20ToERC7984Wrapper")) - 1)) & ~bytes32(uint256(0xff))
            $.slot := 0xf300a8a403a05b9e7bcdd75043021db47ba3d9622fd5490637baf7a878db9900
        }
    }
    ...
    function finalizeUnwrap(
        ...
        ERC20ToERC7984WrapperStorage storage $ = _getERC20ToERC7984WrapperStorage();
